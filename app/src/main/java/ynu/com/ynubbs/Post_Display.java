...
//        System.out.println("ccccccccccccccccccccccccccccccccccccccc");
    ...
    public class MyThread1 implements Runnable {
        ...
        public void run() {
            ...
            Intent intent = new Intent(Post_Display.this, Reply_Submission.class);
            pid=postdataid[0];
            rclass="0";
    ...
    public class MyThread2 implements Runnable {
        ...
        public void run() {
            ...
            info=WebService.DeletePostExecuteHttpGet("DeletePostServlet",postid);
            System.out.println(info);
            Intent intent = new Intent(Post_Display.this, Post_Type.class);
    ...
    public class MyThread4 implements Runnable {
        ...
        public void run() {
            ...
            Intent intent = new Intent(Post_Display.this, Post_Display.class);
    ...
    public class MyThread5 implements Runnable {
        ...
        public void run() {
            ...
            Intent selfIntent = new Intent(Post_Display.this, Post_Type.class);
            posts=WebService.SelectByTypeExecuteHttpGet("SelectByTypeServlet",type);
            ArrayList<HashMap<String,Object>> data = new ArrayList<HashMap<String,Object>>();
            int j=0;
            for (Post ps : posts) {
